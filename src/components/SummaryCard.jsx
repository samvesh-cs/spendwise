export default function SummaryCard({ text, info }) {
  return (
    <div className="p-7 h-full rounded-4xl dark:bg-[#14141A] dark:border-gray-800 bg-[#FFFFFF] border border-gray-200  hover:border-red-500/40  transition duration-200  ">
